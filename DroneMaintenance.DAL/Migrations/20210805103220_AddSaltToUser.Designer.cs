...
namespace DroneMaintenance.DAL.Migrations
{
    ...
    [Migration("20210805103220_AddSaltToUser")]
            ...
            modelBuilder.Entity("DroneMaintenance.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "sam@email.com",
                            Name = "Sam",
                            Password = "821cxGjj1aXrLesJ+/K00e4AioL3S7szr15oAudTcew=",
                            RoleId = new Guid("865ce3fc-de0d-4372-901d-05e0ba2b8d02"),
                            Salt = "yXXjzf8L/Ebz2rc65OZiWQ=="
                        },
                        new
                        {
                            ...
                            Name = "Donald",
                            Password = "1+MrFH2zwmsdMVkOPU1ThxtYDk+zfcBrnhE8MY4gsKQ=",
                            RoleId = new Guid("f6736344-8a7e-43f4-9a1a-facf460b5f3f"),
                            Salt = "7e3P7vLA2hp0pnjKUMJ7Mg=="
                        });
                });
